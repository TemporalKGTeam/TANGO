...
train_quad, val_quad, test_quad = (
    quadruples.iloc[0:len_train],
    quadruples.iloc[len_train : len_train + len_val],
    quadruples[len_train + len_val :],
)
tr = open("train.txt", "w")
...
for quad_val in val_quad.itertuples():
    sub, rel, obj, t = (
        getattr(quad_val, "sub"),
        getattr(quad_val, "rel"),
        getattr(quad_val, "obj"),
        getattr(quad_val, "time"),
    )
