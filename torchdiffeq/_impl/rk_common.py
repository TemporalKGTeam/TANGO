...
from .misc import _compute_error_ratio, _select_initial_step, _optimal_step_size
...
class RKAdaptiveStepsizeODESolver(AdaptiveStepsizeODESolver):
    ...
    def _before_integrate(self, t):
        ...
        self.next_grid_index = min(
            bisect.bisect(self.grid_points.tolist(), t[0]), len(self.grid_points) - 1
        )
    ...
    def _adaptive_step(self, rk_state):
        ...
        y1, f1, y1_error, k = _runge_kutta_step(
            self.func, y0, f0, t0, dt, tableau=self.tableau
        )
        # dtypes:
